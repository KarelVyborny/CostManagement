        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VAT = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CostRequestStatusId = table.Column<int>(type: "int", nullable: false),
                    RequestedById1 = table.Column<int>(type: "int", nullable: false),
                    RequestedById = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReviewedById1 = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CostRequests_CostCodes_CostCodeId",
                        column: x => x.CostCodeId,
                        principalTable: "CostCodes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CostRequests_CostRequestStatuses_CostRequestStatusId",
                        column: x => x.CostRequestStatusId,
                        principalTable: "CostRequestStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CostRequests_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CostRequests_Employees_RequestedById1",
                        column: x => x.RequestedById1,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CostRequests_Employees_ReviewedById1",
                        column: x => x.ReviewedById1,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CostRequests_Periods_PeriodId",
                        column: x => x.PeriodId,
                        principalTable: "Periods",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CostRequests_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "Id", "EndDate", "ProjectName", "StartDate" },
                values: new object[,]
                {
                    { 1, null, "Project 1", null },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CostRequests_CostCodeId",
                table: "CostRequests",
                column: "CostCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_CostRequests_CostRequestStatusId",
                table: "CostRequests",
                column: "CostRequestStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_CostRequests_EmployeeId",
                table: "CostRequests",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_CostRequests_PeriodId",
                table: "CostRequests",
                column: "PeriodId");

            migrationBuilder.CreateIndex(
                name: "IX_CostRequests_ProjectId",
                table: "CostRequests",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_CostRequests_RequestedById1",
                table: "CostRequests",
                column: "RequestedById1");

            migrationBuilder.CreateIndex(
                name: "IX_CostRequests_ReviewedById1",
                table: "CostRequests",
